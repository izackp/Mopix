...
public struct InputCommandList {
    ...
    public let commands:Arr<InputCommand>
...
public struct ControllerState {
    ...
    public var commands:Arr<InputCommand>
    
    static let blank = ControllerState(buttons: PressedControllerButtons(rawValue: 0), commands: Arr<InputCommand>())
