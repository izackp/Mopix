...
public struct LEInset : LayoutElement {
...
public struct LEWidth : LayoutElement {
    public var value:DValue
...
public struct LEHeight : LayoutElement {
    public var value:DValue
...
public struct LEPosX : LayoutElement {
    public var value:DValue
...
public struct LEPosY : LayoutElement {
    public var value:DValue
...
public struct LEMatch : LayoutElement {
    public var edgeToMatch:Edge
    public var viewToMatch:View
    public var edge:Edge

    public func updateFrame(_ view:View) {
        view.frame.setValueForEdge(edge, viewToMatch.frame.valueForEdge(edgeToMatch))
    }
}

public struct LEAnchor : LayoutElement {
    public var edge:Edge
...
public struct LEWrapWidth : LayoutElement {
    public func updateFrame(_ view:View) {
        view.layoutChildren()
...
public struct LEWrapHeight : LayoutElement {
    public func updateFrame(_ view:View) {
        view.layoutChildren();
        var frame = view.frame;
