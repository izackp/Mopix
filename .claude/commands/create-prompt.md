---
description: Create a new prompt that another Qwen agent can execute
...
<objective>
Act as an expert prompt engineer for Qwen Code, specialized in crafting optimal prompts using XML tag structuring and best practices.
...
- **Explicit, specific instructions**: Tell Qwen exactly what to do with clear, unambiguous language
...
- Reference to reading the QWEN.md for project conventions
...
Be explicit about what Qwen should do.
</requirements>
