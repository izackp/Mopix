...
struct ResourceIds {
    var oryx_16bit_scifi_vehicles_105:ImageFlyWeight
    var oryx_16bit_scifi_vehicles_189:ImageFlyWeight
    var bullet:ImageFlyWeight
}
...
public class SIScene : IScene, IUpdate, IDrawable, IEventListener, IResourceCache {
    ...
    public func invalidateCache(_ client: DisplayRenderClient) {
        resourceIds = nil
    }
