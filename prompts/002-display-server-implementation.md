...
**Resource Packs:**
- `uploadPack` — write data to temp dir, mount via VirtualDrive, respond 200. On re-upload with same name, remount (hot-reload). Track which packs belong to which client.
